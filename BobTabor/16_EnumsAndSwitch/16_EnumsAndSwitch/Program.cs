    ...
    class Program
    {
        static void Main(string[] args)
        {
            List<Todo> todos = new List<Todo>()
            {
                ...
                new Todo { Description = "Task 2", EstimatedHours = 2, Status = Status.InProgres },
                ...
                new Todo { Description = "Task 5", EstimatedHours = 6, Status = Status.InProgres },
                ...
                new Todo { Description = "Task 9", EstimatedHours = 8, Status = Status.InProgres },
